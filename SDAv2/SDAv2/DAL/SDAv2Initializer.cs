...
namespace SDAv2.DAL
{
    public class SDAv2Initializer : MigrateDatabaseToLatestVersion<SDAv2Context,Configuration>
    {
        public static void SeedKursyData(SDAv2Context context)
        {
